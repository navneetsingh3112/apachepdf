...
public class BengaliPdf {
    public static void main(String[] args) throws IOException {
        BengaliPdf documentCreation = new BengaliPdf();
        ...
        String outputFilePath = "templates/files/bengali.pdf";
    ...
    private void addJLGHeading(PDPageContentStream contentStream, float yOffset,PDDocument document) throws IOException {
        File fontFile = new File("templates/NotoSansBengali-Regular.ttf");
        if (!fontFile.exists()) {
            throw new IOException("Font file not found: " + fontFile.getAbsolutePath());
        }
        PDType0Font font = PDType0Font.load(document, fontFile);
        String file="templates/bengali.json";
    ...
    public String readLabelFromJson(String filePath, String key) throws IOException {
        ...
        Map<String, String> labels = objectMapper.readValue(new File(filePath), new TypeReference<Map<String, String>>() {
        });
    ...
    public void createContent(PDDocument document, PDPage page) throws IOException {
        ...
        String jsonFilePath = "templates/bengali.json";
        String[] jsonKeys = {
    ...
    private void addTermsAndConditions(PDPageContentStream contentStream, float x, float y) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        JsonNode rootNode = objectMapper.readTree(new File("templates/termsandconditions_bengali.json"));
