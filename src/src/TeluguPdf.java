...
public class TeluguPdf {
    public static void main(String[] args) throws IOException {
        TeluguPdf documentCreation = new TeluguPdf();
        ...
        String outputFilePath = "templates/files/telugu.pdf";
    ...
    private void addJLGHeading(PDPageContentStream contentStream, float yOffset,PDDocument document) throws IOException {
        File fontFile = new File("templates/NotoSansTelugu-Regular.ttf");
        if (!fontFile.exists()) {
            throw new IOException("Font file not found: " + fontFile.getAbsolutePath());
        }
        PDType0Font font = PDType0Font.load(document, fontFile);
        String file="templates/telugu.json";
    ...
    public void createContent(PDDocument document, PDPage page) throws IOException {
        ...
        String jsonFilePath = "templates/telugu.json";
        String[] jsonKeys = {
    ...
    private void addTermsAndConditions(PDPageContentStream contentStream, float x, float y) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        JsonNode rootNode = objectMapper.readTree(new File("templates/termsandconditions_telugu.json"));
