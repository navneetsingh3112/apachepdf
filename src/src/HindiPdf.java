...
public class HindiPdf {
    ...
    public static void main(String[] args) throws IOException {
        HindiPdf documentCreation = new HindiPdf();
        ...
        String outputFilePath = "templates/files/hindi.pdf";
    ...
    public void createContent(PDDocument document, PDPage page) throws IOException {
        ...
        String jsonFilePath = "templates/hindi.json";
        String[] jsonKeys = {
    ...
    private void addTermsAndConditions(PDPageContentStream contentStream, float x, float y) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        JsonNode rootNode = objectMapper.readTree(new File("templates/termsandconditions_hindi.json"));
