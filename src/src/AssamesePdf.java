...
public class AssamesePdf {
    public static void main(String[] args) throws IOException {
        AssamesePdf documentCreation = new AssamesePdf();
        ...
        String outputFilePath = "templates/files/assame.pdf";
    ...
    private void addJLGHeading(PDPageContentStream contentStream, float yOffset,PDDocument document) throws IOException {
        ...
        String file="templates/assame.json";
    ...
    public void createContent(PDDocument document, PDPage page) throws IOException {
        ...
        String jsonFilePath = "templates/assame.json";
        String[] jsonKeys = {
    ...
    private void addTermsAndConditions(PDPageContentStream contentStream, float x, float y) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        JsonNode rootNode = objectMapper.readTree(new File("templates/termsandconditions_assame.json"));
