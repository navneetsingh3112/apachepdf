...
public class MarathiPdf {
    public static void main(String[] args) throws IOException {
        MarathiPdf documentCreation = new MarathiPdf();
        ...
        String outputFilePath = "templates/files/marathi.pdf";
    ...
    private void addJLGHeading(PDPageContentStream contentStream, float yOffset,PDDocument document) throws IOException {
        File fontFile = new File("templates/NotoSansDevanagari-Regular.ttf");
        if (!fontFile.exists()) {
    ...
    public void createContent(PDDocument document, PDPage page) throws IOException {
        ...
        String jsonFilePath = "templates/marathi.json";
        String[] jsonKeys = {
    ...
    private void addTermsAndConditions(PDPageContentStream contentStream, float x, float y) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        JsonNode rootNode = objectMapper.readTree(new File("templates/termsandconditions_marathi.json"));
